...
class TurnProjectedRangeRequest:
    ...
    hero_position: Union[Unset, TurnProjectedRangeRequestHeroPosition] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hero_position: Union[Unset, TurnProjectedRangeRequestHeroPosition]
