...
class PreflopRequest:
    ...
    Attributes:
        ...
        table_size (Union[Unset, str]):  Default: '6max'.
        preflop_version (Union[Unset, PreflopRequestPreflopVersion]): optional; which 6max preflop chart set to use.
            Omit for the platform default (6max). Unknown value -> 400 unsupported_preflop_version.
    """

    hole_cards: str
    positions: "PreflopRequestPositions"
    preflop_actions: list["PreflopRequestPreflopActionsItem"]
    table_size: Union[Unset, str] = "6max"
    preflop_version: Union[Unset, PreflopRequestPreflopVersion] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        preflop_version: Union[Unset, PreflopRequestPreflopVersion]
