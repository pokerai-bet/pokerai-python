...
if TYPE_CHECKING:
  from ..models.preflop_range_response_200_range_additional_property import PreflopRangeResponse200RangeAdditionalProperty
...
class PreflopRangeResponse200Range:
    ...
    additional_properties: dict[str, PreflopRangeResponse200RangeAdditionalProperty] = _attrs_field(init=False, factory=dict)
