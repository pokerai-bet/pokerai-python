...
T = TypeVar("T", bound="FlopTreeResponseRangesRequested")


@_attrs_define
class FlopTreeResponseRangesRequested:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flop_tree_response_ranges_requested = cls(
            oop=oop,
            ip=ip,
        )

        flop_tree_response_ranges_requested.additional_properties = d
        return flop_tree_response_ranges_requested
